...
set_input_delay -add_delay  -clock [get_clocks {clk}]  4.000 [get_ports {key[0]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  4.000 [get_ports {key[1]}]
set_input_delay -add_delay  -clock [get_clocks {clk}]  4.000 [get_ports {key[2]}]
